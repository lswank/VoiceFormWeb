...
export default {
  ...
  safelist: [
    {
      pattern: /(bg|text|border|ring)-(primary|secondary|accent-purple|accent-teal|accent-amber)-(50|100|200|300|400|500|600|700|800|900|950)/,
      variants: ['hover', 'dark', 'dark:hover', 'focus', 'dark:focus'],
    },
  ],
  plugins: [
